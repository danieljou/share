...
const Footer = () => {
    ...
    return (
        <footer className="pt-10 bg-white-800">
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2  bg-white outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                                />
                            </div>
